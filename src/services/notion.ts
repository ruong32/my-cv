...
export class NotionAPI {
  ...
  public async getUsers(userIds: string[], gotOptions?: any) {
  ...
  public async getBlocks(blockIds: string[], gotOptions?: any) {
    return this.fetch<notion.PageChunk>({
  ...
  public async getSignedFileUrls(urls: SignedUrlRequest[], gotOptions?: any) {
  ...
  public async search(params: notion.SearchParams, gotOptions?: any) {
    const body = {
