        ...
        <div className="flex flex-col py-6 gap-8 transition-[padding] duration-300 md:flex-row-reverse md:py-12 lg:py-20">
            <div className="mx-auto max-w-[340px] w-[80%]">
                <div className="relative max-w-full pb-[100%] rounded-full shadow-[0_0_16px_4px] shadow-orange-300">
                    <Image className="absolute w-full h-full rounded-full border-[16px] border-[#00000033] dark:border-[#ffffff55]" src='/asset/image/my-photo.jpg' alt='my photo' />
                </div>
            </div>
            <div className="flex-1">
                ...
                <div className="flex justify-center gap-8 mt-10 md:justify-start">
                    <LinkButton to='https://www.facebook.com/ruong32'>
                        <Facebook />
                    </LinkButton>
                    <LinkButton to='https://m.me/ruong32'>
                        <Messenger />
                    </LinkButton>
                    <LinkButton to='https://github.com/ruong32'>
                        <Github />
                    </LinkButton>
                    <LinkButton to='https://www.linkedin.com/in/ruong32'>
                        <Linkedin />
                    </LinkButton>
                </div>
            </div>
