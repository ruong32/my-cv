    ...
    >
      {dir === "vertical" ? (
        <>
          ...
          <h3 className={cx("mt-2 text-xl text-center", props.titleClassName)}>
            {props.title}
          </h3>
          {props.subTitle && (
            <h4 className={cx("mt-2 text-sm", props.subtitleClassName)}>
              {props.subTitle}
            </h4>
          )}
          {props.description && (
            <div className={cx("mt-2 text-sm", props.descriptionClassName)}>
              {props.description}
            </div>
          )}
        </>
        ...
        <>
          ...
          <div>
            <h3 className={cx("text-xl", props.titleClassName)}>
              {props.title}
            </h3>
            {props.subTitle && (
              <h4 className={cx("mt-2 text-sm", props.subtitleClassName)}>
